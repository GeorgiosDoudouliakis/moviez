...
@Injectable()
export class OnTheAirTvSeriesService implements MoviesTvSeriesActorsListService<TvSerie> {
  constructor(
  ...
  public items$(page: number): Observable<BaseResponse<TvSerie>> {
    return this._httpClient.get<BaseResponse<TvSerie>>(`https://api.themoviedb.org/3/tv/on_the_air?api_key=803a77b2748b6f5d6363b4fa92bfd870&language=en-US&page=${page}`).pipe(
