...
@Injectable()
export class UpcomingMoviesService implements MoviesTvSeriesActorsListService<Movie> {
  constructor(private _httpClient: HttpClient) {}

  public items$(page: number): Observable<BaseResponse<Movie>> {
    return this._httpClient.get<BaseResponse<Movie>>(`https://api.themoviedb.org/3/movie/upcoming?api_key=803a77b2748b6f5d6363b4fa92bfd870&language=en-US&page=${page}`).pipe(
